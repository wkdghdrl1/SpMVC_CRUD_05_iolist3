...
<link rel="stylesheet" type="text/css"
	href="${rootPath}/resources/css/main1.css?ver=20190724">
<link rel="stylesheet" type="text/css"
	href="${rootPath}/resources/css/list.css?ver=20190724">
<link rel="stylesheet" type="text/css"
	href="${rootPath}/resources/css/button.css?ver=20190724">
<link rel="stylesheet" type="text/css"
	href="${rootPath}/resources/css/input.css?ver=20190724">
<link rel="stylesheet" type="text/css"
	href="${rootPath}/resources/css/view.css?ver=20190724">
<link rel="stylesheet" type="text/css"
...
<body>
	...
	<section class="main-section">
		<article id="comp" class="body-box">
			<div id="comp_list"><h1>거래처 검색창</h1></div>
		</article>
		...
		<article id="product" class="body-box">
			<div id="pro_list"><h1>상품 검색창</h1></div>
		</article>
	</section>
